...
export default function SiteWaterwisePage() {
  ...
  const fetchSiteData = useCallback(async () => {
    ...
    try {
      ...
      // Filter and group categories for this site (Waterwise is Shopify)
      const categoriesGrouped = validCategoriesData
        .filter((product: any) => product.channel === 'Shopify')
      ...
      console.error("Error fetching Waterwise site data:", error)
    } finally {
      setLoading(false)
    }
  }, [dateRange])
